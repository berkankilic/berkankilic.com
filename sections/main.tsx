  ...
  return (
    <>
      <div className="relative flex min-h-screen w-full flex-col items-center justify-center py-[90px] -mt-[120px] lg:-mt-[160px] z-10  ">
        <h2 className="text-[32px] md:text-[40px] lg:text-[56px] text-center font-semibold text-transparent bg-clip-text bg-gradient-to-r from-white  to-tertiary-text to-60% transition-all duration-300">
